          ...
          try {
            for (const network of getSquidsNetworksMapping()) {
              ...
              squid.metrics[network.name] = {
                sqd_processor_sync_eta_seconds: getMetricValue(
                  text,
                  "sqd_processor_sync_eta_seconds"
                ),
                sqd_processor_mapping_blocks_per_second: getMetricValue(
                  text,
                  "sqd_processor_mapping_blocks_per_second"
                ),
                sqd_processor_last_block: getMetricValue(
                  text,
                  "sqd_processor_last_block"
                ),
                sqd_processor_chain_height: getMetricValue(
                  text,
